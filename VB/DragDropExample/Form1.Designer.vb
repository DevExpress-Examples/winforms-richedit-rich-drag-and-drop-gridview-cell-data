...
'ORIGINAL LINE: this.richEditControl1.DragDrop += new System.Windows.Forms.DragEventHandler(this.richEditControl1_DragDrop);
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.richEditControl1.DragOver += new System.Windows.Forms.DragEventHandler(this.richEditControl1_DragOver);
			' 
			' Form1
			' 
